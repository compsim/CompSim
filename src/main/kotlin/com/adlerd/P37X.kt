...
class P37X : ISA() {
    public override fun init() {
        super.init()
        createDef("ADD", "0000 ddd sss ttt 100", object : InstructionDef() {
        ...
        createDef("SUB", "0000 ddd sss ttt 101", object : InstructionDef() {
            override fun getDestinationReg(word: Word): Int {
                return this.getDReg(word)
            }
        ...
        createDef("MUL", "0000 ddd sss ttt 110", object : InstructionDef() {
            override fun getDestinationReg(word: Word): Int {
                return this.getDReg(word)
            }
        ...
        createDef("OR", "0001 ddd sss ttt 000", object : InstructionDef() {
            override fun getDestinationReg(word: Word): Int {
                return this.getDReg(word)
            }
            ...
            override fun execute(
                ...
                val var6 = registerFile.getRegister(this.getSReg(word)) or registerFile.getRegister(this.getTReg(word))
                registerFile.setRegister(this.getDReg(word), var6)
                return var2 + 1
            }
        })
        createDef("NOT", "0001 ddd sss xxx 001", object : InstructionDef() {
            override fun getDestinationReg(word: Word): Int {
                return this.getDReg(word)
            }
        ...
        createDef("AND", "0001 ddd sss ttt 010", object : InstructionDef() {
            override fun getDestinationReg(word: Word): Int {
                return this.getDReg(word)
            }
            ...
            override fun execute(
                ...
                val var6 = registerFile.getRegister(this.getSReg(word)) and registerFile.getRegister(this.getTReg(word))
                registerFile.setRegister(this.getDReg(word), var6)
                return var2 + 1
            }
        })
        createDef("XOR", "0001 ddd sss ttt 011", object : InstructionDef() {
            override fun getDestinationReg(word: Word): Int {
                return this.getDReg(word)
            }
            ...
            override fun execute(
                ...
                val var6 = registerFile.getRegister(this.getSReg(word)) xor registerFile.getRegister(this.getTReg(word))
                registerFile.setRegister(this.getDReg(word), var6)
                return var2 + 1
            }
        })
        createDef("SLL", "0001 ddd sss ttt 100", object : InstructionDef() {
            override fun getDestinationReg(word: Word): Int {
                return this.getDReg(word)
            }
        ...
        createDef("SRL", "0001 ddd sss ttt 101", object : InstructionDef() {
            override fun getDestinationReg(word: Word): Int {
                return this.getDReg(word)
            }
        ...
        createDef("SRA", "0001 ddd sss ttt 110", object : InstructionDef() {
            override fun getDestinationReg(word: Word): Int {
                return this.getDReg(word)
            }
        ...
        createDef("RTT", "0011 ddd xxxxxxxxx", object : InstructionDef() {
            override fun getSourceReg1(word: Word): Int {
                return this.getDReg(word)
            }
        ...
        createDef("JUMP", "0100 pppppppppppp", object : InstructionDef() {
            override fun execute(
                word: Word,
                var2: Int,
                registerFile: RegisterFile,
        ...
        createDef("JUMPR", "0101 ddd xxxxxxxxx", object : InstructionDef() {
            override fun getSourceReg1(word: Word): Int {
                return this.getDReg(word)
            }
        ...
        createDef("JSR", "0110 pppppppppppp", object : InstructionDef() {
        ...
        createDef("JSRR", "0111 ddd xxxxxxxxx", object : InstructionDef() {
        ...
        createDef("NOOP", "1000 xxx 000 xxxxxx", object : InstructionDef() {
            override fun execute(
                word: Word,
                var2: Int,
                registerFile: RegisterFile,
        ...
        createDef("BRP", "1000 ddd 001 pppppp", object : InstructionDef() {
...
//                 return if (var6 != 0 && var6 and 8000 == 0) var2 + 1 + this.getPCOffset(word) else var2 + 1
        ...
        createDef("BRZ", "1000 ddd 010 pppppp", object : InstructionDef() {
            override val isBranch: Boolean
                get() = true
        ...
        createDef("BRZP", "1000 ddd 011 pppppp", object : InstructionDef() {
            override val isBranch: Boolean
                get() = true
        ...
        createDef("BRN", "1000 ddd 100 pppppp", object : InstructionDef() {
            override val isBranch: Boolean
                get() = true
        ...
        createDef("BRNP", "1000 ddd 101 pppppp", object : InstructionDef() {
            override val isBranch: Boolean
                get() = true
        ...
        createDef("BRNZ", "1000 ddd 110 pppppp", object : InstructionDef() {
            override val isBranch: Boolean
                get() = true
        ...
        createDef("BRNZP", "1000 ddd 111 pppppp", object : InstructionDef() {
            override val isBranch: Boolean
                get() = true
        ...
        createDef("CONST", "1001 ddd iiiiiiiii", object : InstructionDef() {
            override fun getDestinationReg(word: Word): Int {
                return this.getDReg(word)
            }
        ...
        createDef("INC", "1010 ddd iiiiiiiii", object : InstructionDef() {
            override fun getDestinationReg(word: Word): Int {
                return this.getDReg(word)
            }
        ...
        createDef("LEA", "1011 ddd ppppppppp", object : InstructionDef() {
            override fun getDestinationReg(word: Word): Int {
                return this.getDReg(word)
            }
        ...
        createDef("LDR", "1100 ddd sss iiiiii", object : InstructionDef() {
        ...
        createDef("STR", "1101 ddd sss iiiiii", object : InstructionDef() {
        ...
        createDef("LD", "1110 ddd ppppppppp", object : InstructionDef() {
            override val isLoad: Boolean
                get() = true
        ...
        createDef("ST", "1111 ddd ppppppppp", object : InstructionDef() {
            override val isStore: Boolean
                get() = true
